    ...
    <div class="container">
       <form action="">
       	<table>
       		...
       		<tr>
       			<td>昵称</td>
       			<td><input type="text" name="nikename" value="${user.nikename}"/></td>
       		</tr>
       		<tr>
       			<td>个性签名</td>
       			<td><input type="text" name="signature" value="${user.signature}"  readonly="true"/></td>
       		</tr>
       		<tr>
       			<td>积分</td>
       			<td><input type="text" name="grade" value="${user.grade}"  readonly="true"/></td>
       		</tr>
       		<tr>
       			<td>Email</td>
       			<td><input type="text" name="email" value="${user.email}"  readonly="true"/></td>
       		</tr>
       		<tr>
       			<td></td>
       			<td><button>修改</button>&nbsp;&nbsp;<button>返回到首页</button></td>
       		</tr>
       	</table>
       </form>
    </div>
